...
if len(sys.argv) == 1:
	print("use: python main.py [birth | death ... ] limit")
	sys.exit(1)
...
for person in people:
	property = sys.argv[1]
	if property == "birth" or property == "death":
		thing = person[property][0:4]
	elif property == "knownFor":
		thing = person[property].split("/")[-1].replace("_", " ")
	else:
		warning("What property is that?")
		sys.exit(1)
	...
	try:
		...
		warning(thing + " not found in text: " + text)